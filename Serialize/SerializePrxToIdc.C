...
int CSerializePrxToIdc::StartFile(){
	return 1;
}

int CSerializePrxToIdc::EndFile(){
	/* Do nothing */
	return 1;
}

int CSerializePrxToIdc::StartPrx(const char* szFilename, const PspModule *mod, uint32_t iSMask){
	uint32_t addr;
...
int CSerializePrxToIdc::EndPrx(){
	/* Do nothing */
	return 1;
}

int CSerializePrxToIdc::StartSects(){
	fprintf(m_fpOut, "static createSegments() {\n");
	return 1;
}

int CSerializePrxToIdc::SerializeSect(int num, ElfSection &sect){
	uint32_t shFlags;
	uint32_t shType;
	uint32_t shAddr;
	uint32_t shSize;
...
int CSerializePrxToIdc::EndSects(){
	fprintf(m_fpOut, "}\n\n");
	return 1;
}

int CSerializePrxToIdc::StartImports(){
...
int CSerializePrxToIdc::EndImports(){
	fprintf(m_fpOut, "}\n\n");
	return 1;
}

int CSerializePrxToIdc::StartExports(){
...
int CSerializePrxToIdc::EndExports(){
	fprintf(m_fpOut, "}\n\n");
	return 1;
}

int CSerializePrxToIdc::StartRelocs(){
	fprintf(m_fpOut, "static createRelocs() {\n");
	return 1;
}

int CSerializePrxToIdc::SerializeReloc(int count, const ElfReloc *rel){
...
int CSerializePrxToIdc::EndRelocs(){
	fprintf(m_fpOut, "}\n\n");
	return 1;
}
