...
int CSerializePrxToMap::StartFile(){
	return 1;
}

int CSerializePrxToMap::EndFile(){
	/* Do nothing */
	return 1;
}

int CSerializePrxToMap::StartPrx(const char* szFilename, const PspModule *mod, uint32_t iSMask){
	uint32_t i;
	uint32_t addr;
...
int CSerializePrxToMap::EndPrx(){
	/* Do nothing */
	return 1;
}

int CSerializePrxToMap::StartSects(){
	/* Do nothing */
	return 1;
}

int CSerializePrxToMap::SerializeSect(int num, ElfSection &sect){
	uint32_t shFlags;
	uint32_t shType;
	uint32_t shAddr;
	uint32_t shSize;
...
int CSerializePrxToMap::EndSects(){
	return 1;
}

int CSerializePrxToMap::StartImports(){
	return 1;
}
...
int CSerializePrxToMap::EndImports(){
	return 1;
}

int CSerializePrxToMap::StartExports(){
	return 1;
}
...
int CSerializePrxToMap::EndExports(){
	return 1;
}

int CSerializePrxToMap::StartRelocs(){
	return 1;
}

int CSerializePrxToMap::SerializeReloc(int count, const ElfReloc *rel){
...
int CSerializePrxToMap::EndRelocs(){
	return 1;
}
